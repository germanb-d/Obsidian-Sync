...
**Estructura:** Object + BE + past participle (BE cambia según el tiempo)
...
- No importa / no se sabe quién hizo la acción.
- Se quiere sonar más formal o académico.
- El foco está en el resultado.

### Cómo transformar de activa a pasiva

1. Encontrá el objeto de la activa.
...
→ Active: People use computers every day. → Passive: Computers are used every day.

### Error típico

No dejar el verbo principal en base form. En pasiva necesitás participio pasado:

- ❌ The task is do. → ✅ **The task is done.**