...
# Underline the Head Noun and Translate These Noun Phrases

- The most popular programming languages amongst developers
- The truckload of benefits it brings to the table
- Rich built-in high-level data types
- A powerful easy-to-use scripting language that excels as a “glue” language
- Pretty high chances of a developer forgetting to delete all objects at the end
- A language that ensures a project can be developed easily and efficiently
- The programmers’ needs and requirements

# Find in the Text

- All the examples of COMPARATIVE and SUPERLATIVE adjectives.
- A piece of advice expressed using a MODAL VERB
- A possibility expressed using a MODAL VERB
- An obligation expressed using a MODAL VERB
- Two linking expressions that introduce CONTRAST
- A linking expression that introduces an example
- A phrase that means “Fortalezas y debilidades”
